...
def interfazGrafica():
    ...
    def actualizar_sliders(event, returnValues = 0):
        ...
        print("Hmin: ",Hmin,"Smin: ",Smin,"Vmin: ",Vmin,"Hmax: ",Hmax,"Smax: ",Smax,"Vmax: ",Vmax)
        # Escribir en un archivo
        with open('datos.txt', 'w') as archivo:
            archivo.write(str(Hmin)+","+str(Smin)+","+str(Vmin)+","+str(Hmax)+","+str(Smax)+","+str(Vmax)+","+str(sc))
    ...
    slider1.place(x=20, y=50)  # Puedes ajustar las coordenadas (x, y) según tu preferencia
    #slider1.pack()
    ...
    slider4.place(x=175, y=50)  # Puedes ajustar las coordenadas (x, y) según tu preferencia
    #slider1.pack()
   ...
   #================================================================
    ...
    boton = ttk.Button(ventana, text="Mostrar Valores", command=mostrar_valores)
    #boton.pack()
